...
const InputField = ({ label, type, onChange, value, error }) => {
  // Create a memoized callback function for onChange to improve performance
  ...
  // Create a memoized object of input properties to improve performance
  const inputProps = useMemo(
    ...
    [type, label, value, onChangeCallback, error]
  );

  return (
    <div className="relative mt-4">
      {/* Spread the inputProps object onto the input element */}
      <input {...inputProps} />
      <label
        htmlFor={label}
